...
- تم إصلاح مشكلة متعلقة بإظهار المحتوى على شاشة القفل. (نسخة WinUI من خلال متجر مايكروسوفت فقط)
- تم إصلاح أخطاء في التعامل مع الشاشة الرئيسية المكررة. (نسخة WinUI فقط)
...
- تطبيق حل لخلل re-rentrancy الناتج من TileNotification في حدث ~~Loaded~~ *settings updated* الخاص الأداة. (نسخة WinUI من خلال متجر مايكروسوفت فقط)
